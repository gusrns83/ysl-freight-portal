...
const APP_POLS = new Set([
  ...
  "NANJING", "YANGZHOU", "ZHANGJIAGANG", "TAICANG", "NANTONG", "WUHU", "ZHENJIANG", "LIANYUNGANG", "YANTAI", "CHONGQING", "WUHAN", "SHEKOU",
  "XIAMEN", "NANSHA", "YANTIAN", "HONGKONG", "SHANTOU", "FUZHOU", "HUANGPU/PRD", "QINZHOU",
  "TOKYO", "YOKOHAMA", "NAGOYA", "OSAKA", "KOBE", "HAKATA", "MOJI", "NIIGATA", "ONAHAMA", "HACHINOHE", "SENDAI", "TOMAKOMAI", "SHIMIZU",
...
const DY_POL_MAP = {
  ...
  "NANTONG VIA SHA": "NANTONG",
  NANTONG: "NANTONG",
  "WUHAN VIA SHA": "WUHAN",
  WUHAN: "WUHAN",
  "WUHU VIA SHA": "WUHU",
  WUHU: "WUHU",
  "ZHENJIANG VIA SHA": "ZHENJIANG",
  ZHENJIANG: "ZHENJIANG",
  "CHONGQING VIA SHA": "CHONGQING",
  CHONGQING: "CHONGQING",
  NINGBO: "NINGBO",
  NANJING: "NANJING",
